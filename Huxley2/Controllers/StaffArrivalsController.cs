...
namespace Huxley2.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class StaffArrivalsController : ControllerBase
    {
        private readonly ILogger<StaffArrivalsController> _logger;
        private readonly IStationBoardStaffService _stationBoardService;

        public StaffArrivalsController(
            ILogger<StaffArrivalsController> logger,
